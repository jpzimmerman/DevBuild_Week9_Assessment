...
-- --------------------------------------------------
-- Date Created: 12/14/2018 16:27:03
...
-- Creating table 'Dish1'
CREATE TABLE [dbo].[Dish1] (
    [DishID] int IDENTITY(1,1) NOT NULL,
    [PersonName] nvarchar(50)  NULL,
    [PhoneNumber] nvarchar(24)  NULL,
    [DishName] nvarchar(50)  NULL,
...
-- Creating table 'Guest1'
CREATE TABLE [dbo].[Guest1] (
    [GuestID] int IDENTITY(1,1) NOT NULL,
    [FirstName] nvarchar(50)  NULL,
    [LastName] nvarchar(50)  NULL,
    [AttendanceDate] datetime  NULL,
...
-- Creating primary key on [DishID] in table 'Dish1'
ALTER TABLE [dbo].[Dish1]
ADD CONSTRAINT [PK_Dish1]
    PRIMARY KEY CLUSTERED ([DishID] ASC);
GO

-- Creating primary key on [GuestID] in table 'Guest1'
ALTER TABLE [dbo].[Guest1]
ADD CONSTRAINT [PK_Guest1]
    PRIMARY KEY CLUSTERED ([GuestID] ASC);
GO
